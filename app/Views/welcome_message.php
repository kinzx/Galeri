                                ...
                                <div class="row mb-3">
                                    <div class="col d-flex justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <img src="<?= base_url('/img/seele.jpeg') ?>" alt="Deskripsi gambar" width="40"
                                                height="40" class="me-3  rounded-circle">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                                class="w-5 h-5 me-3" width="35" height="35">
                                                <path
                                ...
                                <div class="row">
                                    <div class="col">
                                        <p>Korem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et
                                            ...
                                            turpis condimentum lobortis. Ut commodo efficitur neque. Ut diam quam, semper
    ...
    <div class="d1">
        ...
        <div class="container">
            ...
            <div class="row text-center text-lg-start">
                <?php foreach ($gambarDariDatabase as $gambar): ?>
                    <div class="col-lg-3 col-md-4 col-6">
                        <a data-bs-toggle="modal" data-bs-target="#exampleModal<?= $gambar['idfoto'] ?>">
                            <?php
                            $gambarPath = base_url('uploads/' . $gambar['lokasifoto']);
                            ?>
                            <img class="img-fluid rounded mb-3" style="width: 200;" src="<?= $gambarPath ?>" alt="">
                        </a>
                    </div>
                <?php endforeach; ?>
            </div>
